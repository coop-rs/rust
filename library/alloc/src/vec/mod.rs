    ...
    [(); { crate::meta_num_slots!(A, CO_ALLOC_PREF) }]:,
{
    ...
    /// ```
    #[unstable(feature = "extract_if", reason = "recently added", issue = "43244")]
    pub fn extract_if<F>(&mut self, filter: F) -> ExtractIf<'_, T, F, A, CO_ALLOC_PREF>
    where
        F: FnMut(&mut T) -> bool,
...
#[allow(unused_braces)]
impl<'a, T: Copy + 'a, A: Allocator, const CO_ALLOC_PREF: CoAllocPref> Extend<&'a T>
    for Vec<T, A, CO_ALLOC_PREF>
where
    [(); { crate::meta_num_slots!(A, CO_ALLOC_PREF) }]:,
{
...
#[stable(feature = "rust1", since = "1.0.0")]
#[allow(unused_braces)]
impl<T, A1, A2, const CO_ALLOC_PREF1: CoAllocPref, const CO_ALLOC_PREF2: CoAllocPref> PartialOrd<Vec<T, A2, CO_ALLOC_PREF2>> for Vec<T, A1, CO_ALLOC_PREF1>
where
    T: PartialOrd,
    A1: Allocator,
    A2: Allocator,
    [(); { crate::meta_num_slots!(A1, CO_ALLOC_PREF1) }]:,
    [(); { crate::meta_num_slots!(A2, CO_ALLOC_PREF2) }]:,
{
    #[inline]
    fn partial_cmp(&self, other: &Vec<T, A2, CO_ALLOC_PREF2>) -> Option<Ordering> {
...
#[stable(feature = "rust1", since = "1.0.0")]
#[allow(unused_braces)]
impl<T, const CO_ALLOC_PREF: CoAllocPref> Default for Vec<T, Global, CO_ALLOC_PREF>
where
    [(); { meta_num_slots_global!(CO_ALLOC_PREF) }]:,
{
