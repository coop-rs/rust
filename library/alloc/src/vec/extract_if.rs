...
#[unstable(feature = "extract_if", reason = "recently added", issue = "43244")]
#[allow(unused_braces)]
impl<T, F, A: Allocator, const CO_ALLOC_PREF: CoAllocPref> Iterator for ExtractIf<'_, T, F, A, CO_ALLOC_PREF>
where
    F: FnMut(&mut T) -> bool,
    [(); { crate::meta_num_slots!(A, CO_ALLOC_PREF) }]:,
{
...
#[unstable(feature = "extract_if", reason = "recently added", issue = "43244")]
#[allow(unused_braces)]
impl<T, F, A: Allocator, const CO_ALLOC_PREF: CoAllocPref> Drop for ExtractIf<'_, T, F, A, CO_ALLOC_PREF>
where
    F: FnMut(&mut T) -> bool,
    [(); { crate::meta_num_slots!(A, CO_ALLOC_PREF) }]:,
{
